...
N'Postman', 
NULL, 
N'[""ept:authorization"",""ept:logout"",""ept:token"",""gt:authorization_code"",""gt:refresh_token"",""rst:code"",""scp:email"",""scp:profile"",""scp:roles"",""scp:all"",""scp:booking"",""scp:facility""]', 
NULL, 
NULL, 
...
NULL, 
N'[""ept:token"",""gt:client_credentials"",""scp:booking"",""scp:facility"",""rst:token""]', 
NULL, NULL, NULL, NULL, 
N'confidential');
