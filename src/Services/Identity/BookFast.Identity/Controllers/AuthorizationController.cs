...
using BookFast.Identity.ViewModels.Authorization;
...
namespace BookFast.Identity.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        private async Task<IActionResult> IssueAuthorizationCodeAsync(OpenIddictRequest request, User user, object application, List<object> authorizations)
        {
            ...
            identity.SetClaim(Claims.Subject, await userManager.GetUserIdAsync(user))
                    ...
                    .SetClaim(ClaimTypes.TenantId, user.TenantId);
